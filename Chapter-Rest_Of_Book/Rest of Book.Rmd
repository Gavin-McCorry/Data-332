...
# R displays the attriubue beeneath the vectors values
one_play
...
### Calculating the expectd roll of the slot machine
```{r}
# dfine wheel
wheel <- c("DD", "7", "BBB", "BB", "B", "C", "0")
...
# probablilities for each combination
...
# Code that can shange each symbol for each case:
vec[vec == "DD"] <- "joker"
vec[vec == "C"] <- "ace"
vec[vec == "7"] <- "king"
vec[vec == "B"] <- "queen"
...
# combine into funciton and it runs 14 times facters
